...
$flash_fallback =<<<EOL
<object class='vjs-flash-fallback' width='640' height='520'>
  ...
  <embed src='../utils/osflv/OSplayer.swf?movie=$file&btncolor=0x333333&accentcolor=0x31b8e9&txtcolor=0xdddddd&volume=30&previewimage=$poster&autoload=off&vTitle=testtitles&showTitle=yes' width='640' height='520' allowFullScreen='true' type='application/x-shockwave-flash'>
</object>
EOL;
?>
...
<head>
  <meta charset="utf-8" />
  <title>RMB Demo Movie Player</title>
...
<body>
  ...
  <div class="video-js-box">
    ...
    <video class="video-js" width="640" height="480" poster="<?php echo $poster ?>" controls preload>
